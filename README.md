...
The project processes raw weather data, performs cleaning, extracts time-based features, computes monthly averages, detects extreme events, and visualizes insights using an interactive dashboard.
